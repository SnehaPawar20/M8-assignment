...
if (localStorage.getItem('employees') !== null) {
 ...
 arrEmployees = [
    [34567892, 'Zak Ruvalcaba', 4563, 'zak@vectacor.com', 'Executive'],
    [34567893, 'Sally Smith', 4564, 'Sally@vectacor.com', 'Administrative'],
    [34567894, 'Pedro Ramirez', 4565, 'Pedro@vectacor.com', 'Sales'],
    [34567895, 'Robin Banks', 4566, 'Robin@vectacor.com', 'Marketing'],
    [34567896, 'Sue Wedge', 4567, 'Sue@vectacor.com', 'Quality Assurance']
];
}
...
function buildGrid() {
    ...
    for (let employee of arrEmployees) {
        ...
        <tr>
            ...
            <td>${employee[3]}</td>
            <td>${employee[4]}</td>
            <td><button style='color:red;' class='btn btn-sm btn-light delete'></button></td>
        </tr>
        `
    }
